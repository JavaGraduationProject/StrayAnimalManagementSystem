...
<div class="layui-container container">
  <div class="layui-row layui-col-space20">
    <div class="layui-col-md8">
      <div class="carousel">
        <div class="layui-carousel" id="images-carousel">
          <div carousel-item>
            <div>
              <a href="article_details.jsp"><img lay-src="<%=request.getContextPath() %>/frontPage/static/images/1.jpeg" width="100%" height="280px;" /></a>
            </div>
            <div>
              <img lay-src="<%=request.getContextPath() %>/frontPage/static/images/2.jpeg" width="100%" height="280px;" />
            </div>
            <div>
              <img lay-src="<%=request.getContextPath() %>/frontPage/static/images/3.jpg" width="100%" height="280px;" />
            </div>
            <div>
              <img lay-src="<%=request.getContextPath() %>/frontPage/static/images/4.jpg" width="100%" height="280px;" />
            </div>
            <div>
              <img lay-src="<%=request.getContextPath() %>/frontPage/static/images/5.jpg" width="100%" height="280px;" />
            </div>
          </div>
        </div>
      </div>
      <div class="article-main">
        ...
        <div class="article-list">
          ...
          <ul>
            ...
            <p>现在跨界联姻，时尚、汽车以及运动品牌联合手机制造商联合发布手机产品在行业里已经不再新鲜，上周我们给大家报道过著名手表制造商瑞士泰格·豪雅（Tag Heuer） 联合法国的手机制造商Modelabs发布的一款奢华手机的部分谍照，而近日该手机终于被正式发布了<%=request.getContextPath() %>/frontPage.</p>
            <p class="autor">
    ...
    <div class="layui-col-md4">
      ...
      <div class="ad"> <img lay-src="<%=request.getContextPath() %>/frontPage/static/images/ad.jpg"> </div>
      <div class="ms-top">
        <ul class="hd" id="tab">
      ...
      <div class="ad"> <img lay-src="<%=request.getContextPath() %>/frontPage/static/images/03.jpg"> </div>
