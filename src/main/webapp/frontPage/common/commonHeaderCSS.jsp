...
<%-- <link href="<%=request.getContextPath() %>/static/global/plugins/bootstrap-switch-master/dist/css/bootstrap3/bootstrap-switch.min.css" rel="stylesheet" type="text/css" /> --%>
...
<%-- <link href=".<%=request.getContextPath() %>/static/global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css" rel="stylesheet" type="text/css" /> --%>
<%-- <link href="<%=request.getContextPath() %>/static/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css" /> --%>
...
<%-- <link href="<%=request.getContextPath() %>/static/global/plugins/jquery-ui-themes-1.12.1/jquery-ui.min.css" rel="stylesheet" type="text/css" /> --%>
...
<%-- <link href="<%=request.getContextPath() %>/static/global/plugins/Guriddo_jqGrid_JS_5.2.0/css/ui.jqgrid.css" rel="stylesheet" type="text/css" /> --%>
...
<%-- <link href="<%=request.getContextPath() %>/static/citys/css/main.css" rel="stylesheet" type="text/css" /> --%>
<%-- <link href="<%=request.getContextPath()%>/static/global/plugins/umeditor1_2_2-utf8-jsp/themes/default/css/umeditor.css" type="text/css" rel="stylesheet"> --%>
